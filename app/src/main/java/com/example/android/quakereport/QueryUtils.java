    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            for (int i = 0; i < quakeFeaturesArray.length(); i ++){
                ...
                JSONObject thisQuake = thisQuakeFeatures.getJSONObject( "properties");

                Double mag = thisQuake.getDouble( "mag" );
                String place = thisQuake.getString( "place" );
                long time  = thisQuake.getLong( "time" );
                String url = thisQuake.getString( "url" );
